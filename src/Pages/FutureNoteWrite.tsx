                    ...
                    <div className="w-[335px] mx-auto pb-4">
                        ...
                        <section className="mt-2">
                            ...
                            <p className="text-[12px] text-[#DFE1EA]/61 mt-1">
                                스토리를 플레이할 수 있는 최대 턴 수입니다. <br />
                                대화의 흐름에 따라 턴 수는 유동적으로 설정됩니다.
                            </p>
                            ...
                            <div className="mt-3 flex flex-col gap-[6px]">
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        <img src="/layer-single.png" alt="단편" className="w-6 h-6" />
                                        <span className="text-[16px] font-semibold text-[#FFF] ml-[5px]">단편 스토리</span>
                                    </div>
                                    <p className="ml-[20px] text-[14px] text-[#DFE1EA]/61">
                                        50~75턴 사이에서 적용됩니다.
                                    </p>
                                </button>
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        <img src="/layers-two.png" alt="일반" className="w-6 h-6" />
                                        <span className="text-[16px] font-semibold text-[#FFF] ml-[5px]">일반 스토리</span>
                                    </div>
                                    <p className="ml-[20px] text-[14px] text-[#DFE1EA]/61">
                                        76~100턴 사이에 적용됩니다.
                                    </p>
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        <img src="/layers-three.png" alt="장편" className="w-6 h-6" />
                                        <span className="ml-[5px] text-[16px] font-semibold text-[#FFF]">장편 스토리</span>
                                    </div>
                                    <p className="ml-[20px] text-[14px] text-[#DFE1EA]/61">
                                        101~125턴 사이에 적용됩니다.
                                    </p>
                        ...
                        <section className="mt-[30px]">
                            ...
                            <div className="mt-3 flex flex-col gap-[6px]">
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        <img src="/Movie3.png" alt="3막 구조" className="w-6 h-6" />
                                        <span className="ml-[5px] text-[14px] font-semibold text-[#FFF]">3막 구조</span>
                                    </div>
                                    <p className="mt-1 ml-8 text-[12px] text-[#A9B1C6]">
                                        발단–위기–결말의 캐주얼한 구조를 가집니다.
                                    </p>
                                </button>
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        <img src="/Movie5.png" alt="5막 구조" className="w-6 h-6" />
                                        <span className="ml-[5px] text-[14px] font-semibold text-[#FFF]">5막 구조</span>
                                    </div>
                                    <p className="mt-1 ml-8 text-[12px] text-[#A9B1C6]">
                                        발단–전개–위기–절정–결말의 구조를 가집니다.
                                    </p>
                                </button>
                            </div>
                        </section>
